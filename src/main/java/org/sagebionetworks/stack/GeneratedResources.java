...
public class GeneratedResources {
	...
	private Map<ConfigSslPrefix, ServerCertificateMetadata> sslCertificates;
	private KeyPairInfo stackKeyPair;
	private Map<ConfigSslPrefix, DescribeConfigurationOptionsResult> elasticBeanstalkConfigurationTemplate;
	...
	public GeneratedResources() {
		this.sslCertificates = new HashMap<ConfigSslPrefix, ServerCertificateMetadata>();
		this.elasticBeanstalkConfigurationTemplate = new HashMap<ConfigSslPrefix, DescribeConfigurationOptionsResult>();
	}
	/**
	 * The search domain.
	 * @return
	 ...
	 * @return
	 */
	public DescribeConfigurationOptionsResult getElasticBeanstalkConfigurationTemplate(final ConfigSslPrefix svcPrefix) {
	 ...
	 * @return
	 */
	public ServerCertificateMetadata getSslCertificate(ConfigSslPrefix prefix) {
	 ...
	 */
	public void setSslCertificate(ConfigSslPrefix prefix, ServerCertificateMetadata sslCertificate) {
