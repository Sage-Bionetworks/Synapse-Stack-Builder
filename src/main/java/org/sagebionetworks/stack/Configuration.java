...
/**
 * Configuration data used to build a stack.
 * 
 * @author John
 *
 */
public class Configuration {
	 ...
	 * @throws IOException
	 */
	public Configuration(Properties configProps) throws IOException{
	...
	public static Properties loadRequired() throws IOException{
		...
		InputStream in = Configuration.class.getClassLoader().getResourceAsStream(REQUIRED_BUILDER_PROPERTIES_NAME);
